...
#    Updated: 2026/01/20 04:50:34 by vbleskin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC				=	cc
CFLAGS			=	-Wall -Werror -Wextra -I includes -I $(LIBFT_DIR)includes -I $(MINLIB_DIR) -pg -O3 -pthread -march=native -ffast-math
